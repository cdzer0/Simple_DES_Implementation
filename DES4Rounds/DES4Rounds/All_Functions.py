...
def Expansion(r_block_str):
    ...
    #exp_all = [31,0,1,2,3,4,3,4,5,6,7,8,7,8,9,10,11,12,11,12,13,14,15,16,15,16,17,18,19,20,19,20,21,22,23,24,23,24,25,26,27,28,27,28,29,30,31,0]
    j = 0
    k = 0
    l = 0
    for i in range(48):
        if i%6==0:
            ...
            l+=1
    #for q in range(48):
    #    exp_r_block_str_1 += r_block_str[exp_all[q]]
    #if exp_r_block_str == exp_r_block_str_1:
    #    print("Success!")
    #else:
    #    print("Fail")
    return exp_r_block_str

#a = Expansion("11001010001101011110000001111001")

def encrypt(block_str, p2key, returned_block_val):
    l_block_str = ""
    r_block_str = ""
    exp_r_block_str = ""
    ...
    returned_block_val['l'] = final_l_block
    returned_block_val['r'] = final_r_block